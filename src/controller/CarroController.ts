...
export class CarroController extends Carro {
    ...
    */
    ...
    /**
     * Método controller para remover um carro.
     * 
     * Esta função recebe uma requisição HTTP contendo o ID de um carro a ser removido como parâmetro na URL.
     * Ela tenta remover o carro correspondente no banco de dados utilizando a função `removerCarro`. 
     ...
     * 
     * @param {Request} req - Objeto de requisição HTTP, contendo o ID do carro a ser removido na URL.
     * @param {Response} res - Objeto de resposta HTTP usado para retornar o status e a mensagem ao cliente.
     * @returns {Promise<Response>} - Retorna uma resposta HTTP com o status 200 em caso de sucesso, ou 400 em caso de erro.
     * 
    ...
    /**
     * Método controller para atualizar os dados de um carro.
     * 
     * Esta função recebe uma requisição HTTP contendo os dados atualizados de um carro no corpo da requisição
     * e o ID do carro a ser atualizado na URL. Ela tenta atualizar o carro correspondente no banco de dados 
     * utilizando a função `atualizarCarro`. Caso a atualização seja bem-sucedida, retorna uma resposta HTTP 200 
     * com uma mensagem de sucesso. Caso contrário, retorna uma resposta HTTP 400 com uma mensagem de erro.
     * 
     * @param {Request} req - Objeto de requisição HTTP, contendo o corpo com os dados atualizados do carro no formato `CarroDTO`
     *                         e o ID do carro a ser atualizado na URL.
     * @param {Response} res - Objeto de resposta HTTP usado para retornar o status e a mensagem ao cliente.
     * @returns {Promise<Response>} - Retorna uma resposta HTTP com o status 200 em caso de sucesso, ou 400 em caso de erro.
     * 
